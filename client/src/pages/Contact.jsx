...
export default function Contact() {
  return (
    <main className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-stone-600">Order original designer Arabian fragrances, oil perfumes, body mists, diffusers, humidifiers, and premium scents directly from Roc Realm Nigeria Limited.</p>
      <div className="mt-10 grid gap-5 md:grid-cols-3">
        ...
        <a href={`tel:${businessInfo.callLine}`} className="rounded-[2rem] bg-white p-6 shadow-sm"><Phone className="text-amber-700" /><h2 className="mt-4 font-semibold">Call Line</h2><p className="text-stone-600">{businessInfo.callLine}</p></a>
