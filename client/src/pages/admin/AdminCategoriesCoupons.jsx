      ...
      <div className="mt-8 grid gap-8 xl:grid-cols-2">
        <div>
          <form onSubmit={addCategory} className="grid gap-4 rounded-[2rem] bg-white p-6 shadow-sm">
            ...
            <input required placeholder="Brand/category name e.g. Lattafa, Dior, Oil Perfumes" value={category.name} onChange={(e) => setCategory({ ...category, name: e.target.value })} className="rounded-2xl bg-stone-100 px-4 py-3 outline-none" />
